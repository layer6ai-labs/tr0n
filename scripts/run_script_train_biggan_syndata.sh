python train.py --exp_name='gmm_syn_biggan1000000_z_norml_y_cat_fixed_cap_model_nuc_10ep_16bs_1e4lr_cosine_0wd_skip_10mix_1e4' \
        ...
        --scheduler='cosine' --weight_decay=0.0 --synthetic_latents_path='syn_biggan1000000_z_norml_y_cat_fixed_cap_model_nuc' \
